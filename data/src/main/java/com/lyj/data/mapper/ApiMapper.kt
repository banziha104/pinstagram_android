...
object ApiMapper {
    fun <ENTITY_DATA, MODEL_DATA> toEntity(model: ApiModel<MODEL_DATA>): ApiResponse<ENTITY_DATA> =
        ApiResponse(
            model.code,
            model.message,
            model.httpCode,
    ...
    fun <ENTITY_DATA, MODEL_DATA> toModel(model: ApiResponse<ENTITY_DATA>): ApiModel<MODEL_DATA> =
        ApiModel(
            model.code,
            model.message,
            model.httpCode,
